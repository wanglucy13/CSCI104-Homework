...
{
  Product* bookProduct = new Book(isbn_, author_, 
    "book", prodName_, price_, qty_);
  return bookProduct;
}
...
{
  Product* clothingProduct = new Clothing(brand_, size_, 
    "clothing", prodName_, price_, qty_);
...
{
  Product* movieProduct = new Movie(genre_, rating_, 
    "movie", prodName_, price_, qty_);
  return movieProduct;
}
