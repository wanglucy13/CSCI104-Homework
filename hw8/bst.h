...
class BinarySearchTree {
 ...
 public:
  ...
  public:
     ...
     */
    bool operator!=(const iterator& rhs) const{
      if(this -> curr -> getKey() != rhs.curr -> getKey()){
        return true;
      }
      if(this -> curr -> getValue() != rhs.curr -> getValue()){
        return true;
      }
      if(this -> curr -> getItem() != rhs.curr -> getItem()){
        return true;
      }
      return false;
    }
    ...
    iterator& operator++(){
      if(curr -> getRight() != NULL){
        curr = curr -> getRight() -> getLeft();
      }
      else{
        if(curr -> getParent() -> getLeft() != NULL){
